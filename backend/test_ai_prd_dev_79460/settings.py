"""
Django settings for test_ai_prd_dev_79460 project.
...
ROOT_URLCONF = 'test_ai_prd_dev_79460.urls'
...
WSGI_APPLICATION = 'test_ai_prd_dev_79460.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_ai_prd_dev_79460 API",
    "DESCRIPTION": "API documentation for test_ai_prd_dev_79460 App",
    "VERSION": "v1",
}
